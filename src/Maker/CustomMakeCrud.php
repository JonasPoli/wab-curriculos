...
use App\Maker\FormTypeRenderer;
...
final class CustomMakeCrud extends AbstractMaker
{
    ...
    public function interact(InputInterface $input, ConsoleStyle $io, Command $command): void
    {
        ...
        $displayName = Str::asClassName(\sprintf('%s', $input->getArgument('entity-class')));
        $this->displayName = $io->ask(
            \sprintf('Choose the display name', $displayName),
            $displayName
        );
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $generator->generateController(
            ...
            __DIR__.'/crud/controller/Controller.tpl.php',
            array_merge([
        ...
        //         __DIR__.'/crud/test/Test.EntityManager.tpl.php',
        //         [
